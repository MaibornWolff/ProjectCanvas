...
export const sortIssuesByRank = (issueA: Issue, issueB: Issue) => issueA.rank.localeCompare(issueB.rank);

export const searchMatchesIssue = (search: string, issue: Issue) => search === ""
